    ...
    <div class="container">
		<div class="margin-top">
			<div class="row">
				...
				<p><a rel="tooltip"  data-placement="bottom" title="Click Here to Sign UP" id="signup" href="signup.php">Not a User? Sign Up Now</a></p>
				</div>
				<!--- login -->
				...
				<div class="span12">
				<div class="caption_index">We provide the best quality counseling service</div>
				</div>		
